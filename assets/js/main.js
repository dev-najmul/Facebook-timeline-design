//Create post form
const add_post_form = document.getElementById("add-post-form");
const msg = document.querySelector(".msg");

//get all post main div
const all_post_wrapper = document.querySelector(".all-post-wrapper");

//show postList
function showPost() {
  //empty variable to rechive valu from loop
  let user_post = ``;
  // check LS previous value
  let fbPostList = getLsData("posts");

  //get all data with loop
  fbPostList.reverse().forEach((item, index) => {
    user_post += `
  <div class="user-post">
  <div class="user-post-header">
    <div class="post-info">
      ...
      <div class="user-details">
        <a class="author" href="#">${item.auth_name}</a>
        <span
          >${timeAgo(item.post_time)}
          <svg
            fill="currentColor"
            viewBox="0 0 16 16"
            width="1em"
  ...
  <div class="post-comments">
    <div class="comments-header">
      <div class="reaction">
        ...
        <a href="#">1.5K Farhan raj Najmul and 1.5k others</a>
      </div>
      <div class="counts">
        <a href="#">780 Comments</a>
      </div>
    </div>
  ...
  all_post_wrapper.innerHTML = user_post;
}

//Show no post found text
if (!localStorage.getItem("posts")) {
  all_post_wrapper.innerHTML = `
  <div class="nopost">
  <div class="card">
    <div class="card-body">
...
add_post_form.onsubmit = (e) => {
  ...
  //form valadition
  if (!formdata.auth_name || !formdata.post_content) {
    msg.innerHTML = createAlert("Fild are requerd");
  } else {
    msg.innerHTML = "";

    let fbpost = getLsData("posts");

    fbpost.push({
      auth_name: formdata.auth_name,
      auth_photo: formdata.auth_photo ?? null,
      post_content: formdata.post_content,
      post_photo: formdata.post_photo ?? null,
      post_time: Date.now(),
    });

    setLsData("posts", fbpost);
    showPost();
